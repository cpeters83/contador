...
<div class="row" id = "contenedorazul">
  <div class = "col-12">
    <p class="text-center"><h1 id = "white" class="display-4">Gerencia Mantenimiento</h1></p>
    <p class="text-center"><h1><p id = "blanco" class="display-4">Subgerencia Mantenimiento Líneas 6 y 3 </p></h1></p>
  </div>
...
<div class="row"> 
   <div class="container-fluid" id = "contenedorazul">
     <h2> <p id= "white"> Recuerde siempre usar los elementos de proteccion personal</p><h2>
   </div>
 </div>
